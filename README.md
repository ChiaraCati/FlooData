...
| D6         |     :---        |      :---       |      Satisfied, data and variables are coherent and exhaustly explained in dataset's metadata available [here](https://idrogeo.isprambiente.it/app/page/open-data)  |       Satisfied: last update 2021 with new codes  |
| D7         |     :---        |      :---       |      :---         |         :---     |
| D8         |     :---        |      :---       |      :---         |         :---     |
| D9         |     :---        |      :---       |      :---         |         :---     |
