...
Catalog of the Defense Works of the Emilia-Romagna Region Coast. SGSS activity report. Reference projects and / or activities: Mare Costa Information System | Dataset containing the coast areas mostly affected by erosion | Landslide and flood risk indicators relating to territory, population, families, buildings, industry and service, cultural heritage Landslide and flood risk indicators relating to territory, population, families, buildings, industry and service, cultural heritage | Dataset containing the tracks of the projects implemented in Emilia Romagna between 2007 and 2013 Dataset containing the tracks of the projects implemented in Emilia Romagna between 2014 and 2020 |
