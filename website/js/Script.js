...
(async () => {
    ...
    const mapChart = Highcharts.mapChart('finance_map', {
        ...
        title: {
            text: 'Population history by prov'
        },
  
        subtitle: {
            text: 'Source: <a href="http://data.worldbank.org/indicator/SP.POP.TOTL/province/1W?display=default">The World Bank</a>'
        },
